...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('EXPENSE_ADDED', 'EXPENSE_UPDATED', 'EXPENSE_DELETED', 'SETTLEMENT_CREATED', 'FRIEND_REQUEST_SENT', 'FRIEND_REQUEST_ACCEPTED', 'GROUP_CREATED', 'GROUP_MEMBER_ADDED', 'GROUP_MEMBER_REMOVED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('EXPENSE_ADDED', 'SETTLEMENT_RECEIVED', 'FRIEND_REQUEST', 'FRIEND_REQUEST_ACCEPTED', 'GROUP_INVITE');
